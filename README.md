...
- [ ] Explain what a token is used for.
  ...
  A token is used for serverside authentication.

- [ ] What steps can you take in your web apps to keep your data secure?

  One thing you can do is to use PrivateRoutes and axiosWithAuth to ensure that only if you are logged in can you access the data.

- [ ] Describe how web servers work.

    The web server gets the IP addres for whatever site the client wants to look for. The web server will then send the desire data(pages).

- [ ] Which HTTP methods can be mapped to the CRUD acronym that we use when interfacing with APIs/Servers.

  Create would be .post, Read would be .get, update would be .put, delete would be .delete.
